...
public class TAlarmPolicyController extends BaseController {
	...
	public String save(String tAlarmPolicyList, String devType, String devIds) {
		...
		try {
			...
			System.out.println(tAlarmPolicyService.selectTAlarmPolicys().toString());
			WebSockertFilter.webSocketClient.send(tAlarmPolicyService.selectTAlarmPolicys().toString());
