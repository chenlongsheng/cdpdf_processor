...
public class PdfOrderService extends CrudService<PdfOrderDao, TOrg> {
	...
	public Map findOrder(PdfOrder pdfOrder, int key) {
        ...
        //	pdfOrderDao.getVideoByChId(resultList.get(0).get("ChId").toString());

		//	resultList.get(0).put("channelVedio",pdfOrderDao.getVideoByChId(resultList.get(0).get("ChId").toString()));
